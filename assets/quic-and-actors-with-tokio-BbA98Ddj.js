...
`,n(e.p,{children:"The purpose of this actor is to only communicate with other actors, possibly even keeping track of certain events (like authentication) out of pure convenience for the programmer."})]}})}function b(r={}){const{wrapper:e}=Object.assign({},i(),r.components);return e?n(e,a(r,{get children(){return n(t,r)}})):t(r)}var w=d('<div class="min-h-screen bg-black text-white"><div class="container w-full md:w-3/4 lg:w-1/2 mx-auto">');function x(){return l(async()=>{hljs.highlightAll(),await u.run({querySelector:".language-mermaid"})}),(()=>{var r=w(),e=r.firstChild;return h(e,n(b,{})),r})()}export{x as default};
