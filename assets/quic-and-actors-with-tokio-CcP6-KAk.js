...
`,n(e.pre,{get children(){return n(e.code,{className:"language-rust",children:`use tokio::sync::{oneshot, mpsc};\r
\r
enum Msg {\r
  Next(oneshot::Sender<u64>),\r
}\r
\r
struct Actor {\r
  id: u64,\r
...
\r
impl Actor {\r
  fn new(rx: mpsc::Receiver<Msg>) -> Self {\r
    Self { \r
      id: 0,\r
      rx,\r
    }\r
...
`,n(e.p,{get children(){return["The example project can be found ",n(e.a,{href:"https://github.com/maxinedeandrade/quic-and-actors-with-tokio",children:"here"}),", where you can find the implementation of the client as well, I haven't included it here given that both the server and the client have nearly identical code when it comes to the actors listed below."]}}),`
...
`]}}),`
`,n(e.li,{get children(){return[`
`,n(e.p,{children:`Legibility is increased given that the effects of an actor is much more apparent in contrast to a monolithic\r
design.`}),`
`]}}),`
`,n(e.li,{get children(){return[`
...
impl Handle {\r
  pub fn new(stream: quinn::SendStream) -> Self {\r
    ...
    let actor = Acotr { stream, rx };\r
\r
    tokio::spawn(async move { actor.run() });\r
\r
    Self { tx }\r
  }\r
\r
...
`]}}),`
`]}}),`
`,n(e.p,{get children(){return["Regardless, I've been really enjoying my experience implementing actors with ",n(e.a,{href:"crates.io/crates/tokio",children:"tokio"})," and ",n(e.a,{href:"crates.io/crates/quinn",children:"quinn"}),"."]}})]}})}function w(r={}){const{wrapper:e}=Object.assign({},o(),r.components);return e?n(e,i(r,{get children(){return n(t,r)}})):t(r)}var y=a('<div class="min-h-screen bg-black text-white"><div class="container w-full md:w-3/4 lg:w-1/2 mx-auto">');function k(){return d(async()=>{hljs.highlightAll(),await u.run({querySelector:".language-mermaid"})}),(()=>{var r=y(),e=r.firstChild;return h(e,n(w,{})),r})()}export{k as default};
